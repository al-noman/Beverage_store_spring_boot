    ...
    <form role="form" action="/frontend/incentives" method="post">
        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <input name="incentive_type" type="radio" value="trial_package" class="form-control" checked>Trial
                package </br>
                <input name="incentive_type" type="radio" value="promotional_package" class="form-control">Promotional
                package
